  ...
  return (
    <div className="max-w-2xl mx-auto p-4">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <input type="text" name="description" placeholder="Description" value={formData.description} onChange={handleChange} className="border p-2 w-full" />

        {/* Image upload */}
        <div>
          <input type="text" name="image" placeholder="Image URL" value={formData.image} onChange={handleChange} className="border p-2 w-full mb-2" />
